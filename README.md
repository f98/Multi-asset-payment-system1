...
By the default the template creates a single `HelloWorld` contract under multiasset_payment_system folder in the `smart_contracts` directory. To add a new contract:
